...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 mb-20 mt-8">
      {/* Header */}
      <div className="flex flex-col sm:mt-4 sm:flex-row sm:items-center sm:justify-between max-sm:ml-4 gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold dark:text-white text-gray-900">Admin Dashboard</h1>
          <p className="text-gray-600 dark:text-white mt-1 text-sm sm:text-base">Monitor and manage your educational platform</p>
        </div>
      </div>
